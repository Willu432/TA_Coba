...
# Load data
dataset = pd.read_csv(r"D:\EKG\Ekstraksi Fitur 12 Lead\Anak WJ\Test rekam 10 duduk (Jeffry)\Data_8_raw.csv", names=["I", "II", "III", "AVR", "AVL", "AVF", "V1", "V2", "V3", "V4", "V5", "V6"], sep=',', skiprows=1, skipfooter=0, dtype=float)
